...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/Ahmed-Shabana/ATFramework.git', :tag => s.version.to_s, :commit => '8e5d16657fc751be39373833efe3963aeb68e557' }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'Pod/sourceFramework/**/*.swift'
